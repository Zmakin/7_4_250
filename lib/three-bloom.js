// Three.js r0.163 postprocessing bundle — EffectComposer + RenderPass +
// ShaderPass + UnrealBloomPass + FullScreenQuad.
// Imports core THREE via the import-map alias 'three' (peer dependency).
// MaskPass/ClearMaskPass omitted — not used by this project.
import {
  AdditiveBlending,
  BufferGeometry,
  Clock,
...
class FullScreenQuad {
	constructor( material ) { this._mesh = new Mesh( _geometry, material ); }

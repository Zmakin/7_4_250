...
function bitcoinPoints() {
  ...
  // Convergence: vertex → (26,±4) → (34,±4) → natural arms at (42,±12)
  pts.push({ x: 16 + CX, y:  0 }); // vertex (output x=24)
  pts.push({ x: 26 + CX, y: -4 }); // upper V step 2 (output x=34)
  pts.push({ x: 26 + CX, y:  4 }); // lower V step 2 (output x=34)
  return pts;
}
